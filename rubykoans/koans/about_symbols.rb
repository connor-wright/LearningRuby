...
class AboutSymbols < Neo::Koan
  ...
  #NOT SURE NEED TO COME BACK TO THIS
  ...
  in_ruby_version("mri") do
    ...
    def test_constants_become_symbols
      ...
      #symbol not defined in all symbols
  ...
  # you could end up creating symbols that conflict with symbols you may manually creat in the project
end
