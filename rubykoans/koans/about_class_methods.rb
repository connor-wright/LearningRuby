...
class AboutClassMethods < Neo::Koan
  ...
  # I belive the demo way cannot be inherited so it remains a class method for only for Demo
  # I belive the shovel operator allows inheritance for class operations which is crazy if true
