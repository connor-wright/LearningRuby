...
class AboutMessagePassing < Neo::Koan
  ...
  def test_methods_can_be_invoked_more_dynamically
    ...
    assert mc.send("caught?")
    assert mc.send("caught" + "?" )    # What do you need to add to the first string? add ?
    assert mc.send("CAUGHT?".downcase )      # What would you need to do to the string? downcase it
  end
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    # had to look this up. send can be used by other classes (library) by default so __send__ 
    # can be used safely
  end
