...
class AboutIteration < Neo::Koan
  ...
  def test_find_locates_the_first_element_matching_a_criteria
    ...
    #instead of returning an array of size 1 it returned the item
  ...
  def test_inject_will_blow_your_mind
    ...
    # first iteration it takes the base value (passed in) first item and preforms an operation on them
    # afterwords it takes the result of that value and preforms the same operation on the next item
  end
  ...
  # before "AboutSandwichCode"
  # my guess is that file is created at runtime and then cleaned up after not leaving vars hanging around
